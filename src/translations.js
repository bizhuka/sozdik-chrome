export const translations = {
    ...
    'Text': ['Мәтін', 'Текст'],
    'History Limit': ['Лимит', 'Лимит'],
    'Request Delay (ms)': ['Кідіріс (мс)', 'Задержка (мс)'],
    'Sozdik.kz About': ['Sozdik.kz', 'Sozdik.kz'],
    'Plugin About': ['Қосымша туралы', 'О расширении'],
    'Delete all': ['Тазарту', 'Очистить'],
    'History': ['Журнал', 'История'],
    'Cancel': ['Болдырмау', 'Отмена'],
    'Confirm': ['Растау', 'Подтвердить'],
    'Are you sure you want to clear search history?': ['Журналды тазартуға сенімдісіз бе?', 'Очистить историю?'],
    'Confirm Deletion': ['Тазарту', 'Очистка'],
    'No search history found': ['Журнал бос', 'История пуста'],
    'Anki': ['Anki', 'Anki'],
    'Anki Deck': ['Колода', 'Колода'],
    'Anki Note Type': ['Жазба түрі', 'Тип заметки'],
    'Archive': ['Мұрағаттау', 'Архивировать'],
    'Unarchive': ['Мұрағаттан шығару', 'Разархивировать'],
    'Archived': ['Мұрағатталған', 'Архивировано'],
